...
#      vaderSentiment nltk
#   2. Place reviews_0_250.csv in the same folder
...
# Check if CSV exists
if not os.path.exists("reviews_0_250.csv"):
    st.error("❌ reviews_0_250.csv not found! Please place it in the same folder as app.py")
    st.stop()
